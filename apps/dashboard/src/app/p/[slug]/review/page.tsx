...
function ReviewCard({ detail, base, onAction }: { detail: RunDetail; base: string; onAction: () => void }) {
  const router = useRouter();
    ...
    <div className="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
      <div className="p-5 border-b border-gray-700">
        <div className="flex items-start justify-between gap-3">
          ...
          <button
            onClick={() => router.push(`${base}/runs/${run.id}`)}
        ...
        {!showRevisionForm ? (
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              placeholder="Например: Добавь больше конкретных примеров…"
              value={comment}
