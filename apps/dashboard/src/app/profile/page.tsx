...
const FIELDS: { key: keyof ProjectProfile; label: string; placeholder: string; rows: number }[] = [
  {
    ...
    placeholder: 'Кратко опишите, чем занимается ваш бизнес…',
    rows: 2,
  },
  {
    key: 'audience',
  ...
  },
  {
    ...
    placeholder: 'Что вы продаёте? Цены, преимущества…',
    rows: 3,
  },
  {
    key: 'tone',
    label: 'Тон и стиль',
    placeholder: 'Например: дружелюбный и экспертный, без формализма…',
    rows: 2,
  },
  {
    key: 'taboo',
    label: 'Запреты и ограничения',
    placeholder: 'Что нельзя писать? Конкуренты, темы, слова…',
    rows: 2,
  },
  {
    key: 'examples',
    label: 'Примеры удачных постов',
    placeholder: 'Вставьте примеры текстов, которые вам нравятся…',
    rows: 4,
  },
];
...
export default function ProfilePage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      ...
      {error && (
        <p className="text-red-400 text-sm mt-4">⚠️ {error}</p>
      )}
