...
export default function RunDetailPage() {
  ...
  async function handleRejectPlan() {
    ...
    setActionBusy(true);
    try { await rejectPlan(runId); router.push('/runs'); }
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <div className="bg-gray-800 rounded-xl p-5 mb-5 border border-gray-700">
        ...
        {/* Кнопки: ожидание одобрения плана */}
        ...
        {/* Кнопки: ожидание проверки результата */}
        ...
        {/* Кнопка "Повторить" для завершённых */}
          ...
          {editing ? (
            ...
            <div className="space-y-3">
              <div>
                ...
                >
                  {ALL_AGENTS.map(([slug, agentName]) => (
                    <option key={slug} value={slug}>{AGENT_EMOJI[slug]} {agentName}</option>
                  ))}
                </select>
              </div>
              <div>
